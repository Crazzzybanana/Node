            ...
            <div className="footerWraper">
                <footer>
                    <div className="footerContact">
                        ...
                        <div className="fas fa-robot"><a rel="noopener noreferrer" target="_blank" href="https://telegram.me/AManagerHelperBot">TBot</a></div>
                        ...
                        <div className="fas fa-at"><a rel="noopener noreferrer" target="_blank" href="https://telegram.me/CrazzyBanan">Email</a></div>
                    </div>
                </footer>
            </div>
        );
